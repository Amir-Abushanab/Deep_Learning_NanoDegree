...
class NeuralNetwork():
    ...
    #The sigmoid function, which describes the curve
    ...
    def train(self, training_set_inputs, training_set_outputs, number_of_train_iterations):
        for iteration in range(number_of_train_iterations):
    ...
    def predict(self, inputs):
        #pass the inputs through our neural network (our single neuron)
